                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex gap-1.5">
                    <input
                      ...
                      className="flex-1 px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 font-mono text-[11px]"
                    />
                    <button
                      type="button"
                      onClick={async () => {
                        const space = await createGoogleMeetSpace();
                        setSgGoogleMeet(space.meetingUri);
                      }}
                      className="px-2.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-[11px] font-bold shadow transition flex items-center gap-1 whitespace-nowrap"
                      title="Auto-create a Google Meet space"
                    >
                      <span>Auto Meet</span>
                    </button>
                  </div>
